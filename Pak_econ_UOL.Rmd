...
| Bilateral       | 30% |
| Commercial   | 22% |
###Latter two : only used for financing CAD and no capital investment
...
--
### Fundamentally wrong questions: Economy is not a sectoral approach, one cant fix it by considering it a complicated phenomenon
...
### Reality: Software and hardware has to co-evolve
---
class:  left   title-slide
background-image: url(uol.jpg)
background-position: 100% 0%
...
- #### low productivity
- ###  .orange[Elite Capture: Everywhere but engaged in productive activities: China, Japan (in the past) and export oriented.]
